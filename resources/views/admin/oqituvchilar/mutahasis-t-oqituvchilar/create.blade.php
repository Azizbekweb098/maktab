...
@section('admin')
<form action="{{ route('mutaxasiz.store') }}" method="POST"  enctype="multipart/form-data">
    @csrf
    <div class="container mt-4" style="margin-left: 320px">
        ...
        <div class="mb-3">
            <label for="ishi" class="form-label">ishi</label>
            <input type="text" class="form-control form-control-sm w-75" name="ishi" id="image" required>
        </div>
