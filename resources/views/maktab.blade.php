...
@section('navbar')
            <!-- Big logo start -->
            <div class="bigBannerContent" style="background-image: url('{{ asset('maktab/image/329-maktab.jpg') }}');">
        ...
        <section>
            <div class="container">
                ...
                <div class="mainServicesList">
                    <a href="#">
                        <div class="icon">
                            <img alt="icon" src="{{ asset('maktab/image/oquvchi.png') }}" width="45%" style="margin-left: 60px;">
                        </div>
                        <h1>O'quvchilarga</h1>
                    ...
                    <a href="#">
                        <div class="icon">
                            <img alt="icon" src="{{ asset('maktab/image/Ota-ona.png') }}" width="45%" style="margin-left: 75px;">
                        </div>
                        <h1>Ota-onalarga</h1>
                        <div class="description">
                    ...
                    <a href="#">
                        <div class="icon">
                            <img alt="icon" src="{{ asset('maktab/image/oqtuvchi.png') }}" width="45%" style="margin-left: 80px;">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-12 wow fadeInRight" data-wow-duration=".9s" data-wow-delay=".6s">
                            <div class="onlineSchool__img">
                                <img src="{{ asset('maktab/image/onlineSchool2.png') }}" width="75%" alt="OnlineSchool">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="news">
                    <div class="row mb-4">
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-duration=".9s" data-wow-delay=".6s">
                            <a href="#">
                                <div class="imageBox">
                                    <img alt="image" src="{{ asset('maktab/image/329-maktab.jpg') }}" width="170px">
                                </div>
                        ...
                        <div class="slider">
                            <a href="">
                                <div class="slider_content">
                                    <img src="{{ asset('maktab/image/gerb_slider.jpg') }}" width="10%" alt="Image 1">
                                    <h1>O'zbekiston respulikasi davlat maktabi 1</h1>
                                </div>
                            </a>
                            <a href="">
                                <div class="slider_content">
                                    <img src="{{ asset('maktab/image/Oliy majlis.jpg') }}" width="10%" alt="Image 1">
                                    <h1>O'zbekiston Respublikasi hukumat portali</h1>
                                </div>
                            </a>
                            <a href="">
                                <div class="slider_content">
                                    <img src="{{ asset('maktab/image/mygovUz.jpg" wi') }}dth="10%" alt="Image 1">
